...
USE TPM_FLT
USE CUBLAS_MOD       ,ONLY : CUDA_SGEMM_BATCHED, CUDA_DGEMM_BATCHED
#ifdef TRANS_SINGLE
#define CUDA_GEMM_BATCHED CUDA_SGEMM_BATCHED
#else
#define CUDA_GEMM_BATCHED CUDA_DGEMM_BATCHED
#endif
...
!*       1.1      PREPARATIONS.
#ifdef ACCGPU
!$ACC DATA  COPYIN (D_MYMS,G_NDGLU,D_NUMP,R_NDGNH,R_NSMAX, KFC, KSTA) &
!$ACC&      COPYIN (ITDZBA, ITDZBS, ITDZCA, ITDZCS) &
...
!$OMP&      SHARED(D_NUMP,R_NSMAX,KFC,KSTA,D_MYMS,IZBS,TDZAA,IF_FS_INV,ZIA) DEFAULT(NONE)
#endif
#ifdef ACCGPU
