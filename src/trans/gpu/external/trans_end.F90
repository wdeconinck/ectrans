...
USE TPM_FIELDS        ,ONLY : F, FIELDS_RESOL,F_RW, ZIA,ZEPSNM,ZSOA1,ZAOA1,ISTAN,ISTAS,ZSIA,ZAIA,ZOA1,ZOA2, &
&                             ZAA,ZAS,LDZAA,LDZAS,TDZAA,TDZAS,&
&                             IZBS,ILDZBA,ILDZBS,ITDZBA,ITDZBS,&
&                             IZCA,IZCS,IZCST,ILDZCA,ILDZCS,ITDZCA,ITDZCS,&
&                             DZBAT,DZBST,DLDZBA,DLDZBS,DTDZBA,DTDZBS,&
&                             DZCA,DZCS,DZCAT,DZCST,DLDZCA,DLDZCS,DTDZCA,DTDZCS
...
IF (CLMODE == 'FINAL') THEN
...
#ifdef ACCGPU
  !$ACC EXIT DATA DELETE(ZAA,ZAS,IZBS,IZCST,DZBAT,DZBST,DZCAT,DZCST)
#endif
#ifdef OMPGPU
  !$OMP TARGET EXIT DATA MAP(DELETE:ZAA,ZAS,IZBS,IZCST,DZBAT,DZBST,DZCAT,DZCST)
#endif
...
#endif
#ifdef OMPGPU
  !$OMP TARGET EXIT DATA MAP(DELETE:ZGTF)
#endif
  DEALLOCATE(ZGTF)
  ...
  !DEALLOCATE(ZOA2)
#ifdef ACCGPU
  !$ACC EXIT DATA DELETE(ZIA,ZEPSNM,ZSOA1,ZAOA1,ISTAN,ISTAS,ZSIA,ZAIA,ZOA1)
#endif
#ifdef OMPGPU
  !$OMP TARGET EXIT DATA MAP(DELETE:ZIA,ZEPSNM,ZSOA1,ZAOA1,ISTAN,ISTAS,ZSIA,ZAIA,ZOA1)
#endif
...
#ifdef ACCGPU
  !$ACC EXIT DATA DELETE(R_NSMAX,R_NTMAX,R_NDGL,R_NNOEXTZL,R_NDGNH,D_NSTAGT0B,D_NSTAGT1B,D_NPNTGTB1,D_NPROCL,D_NUMP, &
  !$ACC& D_MYMS,G_NDGLU,G_NMEN,G_NMEN_MAX,G_NLOEN,G_NLOEN_MAX,D_NSTAGTF,D_MSTABF,D_NPNTGTB0,D_NPROCM,D_NPTRLS,D_NASM0,F_RW)
#endif
#ifdef OMPGPU
  !$OMP TARGET EXIT DATA MAP(DELETE:R_NSMAX,R_NTMAX,R_NDGL,R_NNOEXTZL,R_NDGNH,D_NSTAGT0B,D_NSTAGT1B,D_NPNTGTB1,D_NPROCL,D_NUMP, &
  !$OMP& D_MYMS,G_NDGLU,G_NMEN,G_NMEN_MAX,G_NLOEN,G_NLOEN_MAX,D_NSTAGTF,D_MSTABF,D_NPNTGTB0,D_NPROCM,D_NPTRLS,D_NASM0,F_RW)
#endif  
